...
import getStarted from "../../assets/get_started.svg";
    ...
    <section className=" text-white py-16 px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <button className="mt-8 px-6 py-3 flex items-center gap-2 rounded-lg bg-purple-500">
            <img src={getStarted} alt="get started" className="w-5 h-5" />
            Get Started
          </button>
        ...
        <div className="flex justify-center">
          <div className="bg-[#2A2A2E] rounded-xl overflow-hidden shadow-lg max-w-sm">
            <img
              src={HeroImage}
              alt="Hero NFT"
